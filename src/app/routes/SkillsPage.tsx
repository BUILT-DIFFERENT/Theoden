...
export function SkillsPage() {
  ...
  return (
    <div className="skills-page-container space-y-6">
      ...
      <section className="surface-panel p-5">
        ...
        <div className="skills-grid mt-4 grid gap-3 lg:grid-cols-2">
      ...
      {newSkillOpen ? (
        <div className="codex-dialog-overlay fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4 py-6">
          <div className="codex-dialog surface-panel w-full max-w-lg p-5">
            <div className="flex items-center justify-between">
