...
- [x] `environmentMode: "local" | "worktree" | "cloud"`
...
- [x] **Open** dropdown:
  - [x] opens menu with open targets (e.g., open in terminal, editor, file explorer)
  - [x] includes “Copy path”
- [ ] **Git status chip**:
...
- [x] Pills: `Local`, `Worktree`, `Cloud`
- [x] Selecting mode updates `environmentMode` and may trigger flows:
...
- [x] Title + version + source (Team/Community)
- [ ] Documentation panel
- [ ] Actions:
  - [x] `Try`
  - [x] `Open`
  - [x] `Uninstall` (if installed)
  - [x] overflow `…`
...
- [x] Top-bar Git menu dispatches commit / push / create PR actions
...
- [x] `openPathInExplorer(path)`
- [x] `openInEditor(path, editorId)`
- [x] `toggleTerminal()`
