...
- [x] **Protocol parity map closure:** Thread/turn/approval/auth signal mappings are now documented with concrete Tauri/frontend equivalents in `docs/custom/signal-parity-map-tauri.md`, OAuth completion flows are implemented for account + MCP paths, and local OAuth deferral text has been removed. Latest harness audit capture: `docs/custom/official-debug-audit-2026-02-09.json` (run id `08946d8b-8e6d-4774-bd26-f957aee9cd76`). Electron reference: `third_party/CodexDesktop-Rebuild/signal-parity-map.md`.
